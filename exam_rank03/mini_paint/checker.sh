...
### HEADER
echo -e "${orange}___________________________________________________________________________________________________________\n"
echo -e "_____________________________________________ MINI_PAINT CHECKER __________________________________________\n"
echo -e "___________________________________________________________________________________________________________\n\n"


### COMPILATION
echo -e "${orange}Compilation...${clear}"
clang -Wall -Wextra -Werror -lm mini_paint.c
...
echo -e "\n${orange}Testing output and return value with wrong values: first line (WIDTH HEIGHT BACKGROUND_CHAR)...${clear}"
...
echo -e "\n\n${orange}Testing output and return value with wrong values: other lines (c/C X Y RADIUS CHAR)...${clear}"

echo -e "Return value\t\c"
for line in "110 100 c\na" "100 100 c\nr -2" "100 100 c\nR 12.1 -2" "100 100 c\nr 11.1 22.2 33.3 @" "100 100 c\nr 1.1 2.2 -3.3 c" "100 100 c\nb 1.1 2.2 3.3 c" "100 100 c\nR 2.0 1.0 -3.0 c" "100 100 c\nR 0 1 2 d" "100 100 c\nr 2 3 0 e"; do
        wrong_test return_value ${line}
done
